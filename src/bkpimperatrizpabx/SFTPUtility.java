...
public class SFTPUtility {
   ...
   /* public static void main(String[] args) {
        String hostName = "10.10.10.7";
        String username = "root";
        String password = "1nt3gr4";

        String localFilePath = "C:\\Users\\Lobo\\Documents\\NetBeansProjects\\BKPAutomaticoSCGAS\\teste\\teste.png";
        String remoteFilePath = "/etc/IntegraServer/reports/voice.png";       
        //String remoteTempFilePath = "/etc/IntegraServer/reports/Calidad2.jrxml";
